...
public class EditTOGUI extends JFrame {
    ...
    public EditTOGUI(String techId, String name, String email, String nic, String dob,
                     String no, String street, String city, String profilePic, ViewTOGUI parent) {
        setContentPane(mainPanel);
        setTitle("Edit Technical Officer");
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setSize(600, 700);
        setLocationRelativeTo(null);

        //load data into fields
        idtextField.setText(techId);
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement(
                    "SELECT Phone FROM TECH_OFFICER_PHONE WHERE Techoff_id = ?"
            );
        ...
        saveButton.addActionListener(e -> {
            String query = "UPDATE TECH_OFFICER SET Name=?, Email=?, Nic=?, Dob=?, No=?, Street=?, City=? WHERE Techoff_id=?";
            try {
                Connection con = DBConnection.getConnection();
                ...
                ps.setString(5, notextField.getText());
                ps.setString(6, streettextField.getText());
                ...
                if (!contacttextField1.getText().isEmpty()) {
                    PreparedStatement psP1 = con.prepareStatement(
                            "INSERT INTO TECH_OFFICER_PHONE (Techoff_id, Phone) VALUES (?, ?)");
